...
/* WHMCS account settings */
define('_WHMCS_API_URL_', 'http://support.ipt.vn/includes/api.php');
define('_WHMCS_API_USERNAME_', 'quantrinoc');
define('_WHMCS_API_PASSWORD_', 'caphelau3@199');

define('_WS_DEBUG_', false);											// Debug mode
