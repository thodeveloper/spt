...
<?php /*%%SmartyHeaderCode:959053f06008c93c08-41765840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '096ca4ec1663aa6d9c08cffe104207aa8d798679' => 
    array (
  ...
  'nocache_hash' => '959053f06008c93c08-41765840',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53f06008c9dc85_23470836',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53f06008c9dc85_23470836')) {function content_53f06008c9dc85_23470836($_smarty_tpl) {?><div id="window_user" >
	<div class="div_pop">
        <div class="div_form">
            <p class="form">
                <span class="text"><i>*</i> Company Name:</span>
        ...
        <div class="div_form">
            <p class="form">
                <span class="text"><i>*</i> Company Adress:</span>
                <input type="text" class="xsm" />
        ...
        <div class="div_form">
            <p class="form">
                <span class="text"><i>*</i> Surrogate:</span>
                <input type="text" class="xsm" />
                <span class="notice"><i class="fa fa-exclamation-circle"></i>(0-9, a-z, _-)</span>
            </p>
        </div>
        ...
        <div class="div_form">
            <p class="form">
                <span class="title">Thông tin người đăng ký</span>
        ...
        <div class="div_form">
            <p class="form">
                <span class="text"><i>*</i> Email:</span>
                <input type="text" class="xsm" />
                <span class="notice"><i class="fa fa-exclamation-circle"></i>(0-9, a-z, _-)</span>
            </p>
        </div>
        <div class="div_form">
            <p class="form">
                <span class="text"> Email sub:</span>
                <input type="text" class="xsm" />
                <span class="notice"><i class="fa fa-exclamation-circle"></i>(0-9, a-z, _-)</span>
            </p>
        </div>
        ...
        <div class="div_form">
            <p class="form">
                <span class="text"><i>*</i> Confirm Password:</span>
                <input type="text" class="xsm" />
                <span class="notice"><i class="fa fa-exclamation-circle"></i>(0-9, a-z, _-)</span>
            </p>
        </div>
        <div class="div_form">
            <p class="form">
                <span class="text"><i>*</i> Charge Money Value:</span>
                <input type="text" class="xsm" />
                <span class="notice"><i class="fa fa-exclamation-circle"></i>(0-9, a-z, _-)</span>
            </p>
        </div>
        ...
        <div class="div_form">
            <p class="form">
                <span class="text"><i>*</i> Payment:</span>
                <select class="xsm long">
                    <option>HCM</option>
                    <option>HN</option>
                </select>
            </p>
